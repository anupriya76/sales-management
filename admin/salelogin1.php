...
<ul><li> <a href="salelogin1.php"> Login status of Salesman<a/></li><hr>
...
echo '';
?>
<a id="icon2" href="salelogin1.php"><i class="fas fa-sync-alt"> click to refresh</i></a>
...
{
?>
<a id='act' href="saleaction.php?USERID=<?php echo $row['SALESMAN_NUMBER'];?>" 
...
{
?>
<a  id='deact'  href="saleaction.php?USERID=<?php echo $row['SALESMAN_NUMBER'];?>" 
