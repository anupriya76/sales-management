...
<a href="action.php?id=<?php echo $row['ID'];?>" 
 class="act" onclick="return confirm('You Want TO Deactivate <?php echo $row["NAME"];?> Login');"> Deactivate </a>
<?php
}
if(($status)=='deactive')
{
?>
<a href="action.php?id=<?php echo $row['ID'];?>" 
 class="deact" onclick="return confirm(' You Want To Activate <?php echo $row["NAME"];?> Login');"> Activate</a>
<?php
}
?>
