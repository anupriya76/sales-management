...
if($_SESSION['username']){
	?>
Welcome <?php echo $_SESSION['username'];}?><a id="icon2" href=deleteproduct.php><i class="fas fa-sync-alt"> click to refresh</i></a> </p>
</div>
<div class="right1">
<p> DASHBOARD</p>
</div>
...
<td ID="NEW"><a onclick="return confirm(' All The Salesman Under This Supervisor Will also be Deleted.Are you sure to delete.?')" href="deleteproductdatabase.php?IDP=<?php echo $row["PRODUCT_NUMBER"];?>">Delete</a></td>
</TR>
<?php
}
?> 
