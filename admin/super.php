...
if($_SESSION['username']){
	?>
Welcome <?php echo $_SESSION['username'];}?><a id="icon2" href="super.php"><i class="fas fa-sync-alt"> click to refresh</i></a> </p>
</div>
<div class="right1">
...
?>
<div id="ent">
<h2 class=add> Click To Add Supervisor <a id="entry" href="addssupervisor.php">New Entry</a></h2>
</div>
</div>
</div>
</body>
