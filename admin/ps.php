...
$strSQL="SELECT salesman_number,sum(quantity) as quantity FROM product_order group by salesman_number";
...
<th> Click to see detail of salesman</th>
</tr> 
<?php  
...
<td ID="NEW"> <a href="ps1.php?SALESMAN=<?php echo $row["SALESMAN_NUMBER"];?>">SEE DETAILS</a></TD>
<td ID="NEW"> <a href="ps2.php?SALESMAN=<?php echo $row["SALESMAN_NUMBER"];?>">SEE DETAILS</a></TD>
</TR>
<?php
}
?> 
