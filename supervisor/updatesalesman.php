...
$strSQL="select name,salesman_number, state,city,pincode,salary,phone_number   from salesman where id='".$_SESSION['password']."'";  
...
<td class="edit"><a href="updatesalesmanphp.php?userid=<?php echo $row["SALESMAN_NUMBER"];?>">Edit</a></td>
